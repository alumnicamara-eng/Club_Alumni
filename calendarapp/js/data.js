...
const CICLOS = ['DAW', 'DAM', 'Marketing', 'Administración', 'Comercio Internacional'];
...
const DATA = {
  ...
  news: [
    ...
    { id:2, title:'5 empresas del Vivero buscan talento Alumni',              summary:'Ofertas activas para perfiles de DAW, DAM, Marketing y Administración. Acceso prioritario a alumni.',                tag:'empleo',   date:'2026-05-08', wpUrl:'https://alumni.camarafp.es/?p=102' },
  ...
  posts: [
    ...
    { id:3, authorDni:'99887766', cat:'logro',    body:'Acabo de firmar mi primer contrato indefinido en PwC. Gracias a todo el equipo Alumni por las recomendaciones de prepa de entrevistas.', date:Date.now()-9e6, likes:['12345678','87654321','44556677'], comments:[] },
  ],
